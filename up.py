...
in five applications**. This is what it found here.
    ...
    one literal `assert True`, in tests/test_error_handler.py

    NOTE: this application needs Python 3.12 or newer -- seven of its
    files use `type X = ...`, which 3.11 cannot parse. Run this
    script with the same interpreter its CI uses.
