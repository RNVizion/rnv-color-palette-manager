...
rnv-color-palette-manager: install the gold-as-text guard, with four resolver fixes
...
DESCRIPTION = "install the gold-as-text guard, with four resolver fixes"
...
TEXTLESS = ('add-line', 'add-page', 'chunk', 'drop-down', 'groove', 'handle', 'indicator', 'scroller', 'separator', 'sub-line', 'sub-page')
