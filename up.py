...
rnv-color-palette-manager: make the test-tooling pins agree with the other four applications.
...
WHAT THIS DOES. Rewrites 5 specifier(s) in 2 file(s) to the fleet
...
EDITS = [('tests/requirements-dev.txt', 'pytest>=8.0.0\n', 'pytest>=8.0,<10.0\n', 1), ('tests/requirements-dev.txt', 'pytest-qt>=4.4.0          # Qt widget testing\n', 'pytest-qt>=4.4,<5.0          # Qt widget testing\n', 1), ('tests/requirements-dev.txt', 'pytest-benchmark>=4.0.0    # Benchmark suite for color math + palette I/O\n', 'pytest-benchmark>=4.0,<6.0    # Benchmark suite for color math + palette I/O\n', 1), ('requirements.txt', 'pytest>=8.0.0\n', 'pytest>=8.0,<10.0\n', 1), ('requirements.txt', 'pytest-qt>=4.4.0\n', 'pytest-qt>=4.4,<5.0\n', 1)]
CANON = {'pytest': '>=8.0,<10.0', 'pytest-qt': '>=4.4,<5.0', 'pytest-cov': '>=5.0,<8.0', 'pytest-timeout': '>=2.4,<3.0', 'pytest-benchmark': '>=4.0,<6.0'}
DECLARING_FILES = ['tests/requirements-dev.txt', 'requirements.txt']
