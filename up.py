...
Re-walk rnv-color-palette-manager's light status text to the boundary the gold already stops at.
...
MISSING_HELP = (
    "run this from the root of a rnv-color-palette-manager checkout.\n\n"
    "If you ARE in one, the status-family migration has not been applied here "
    "yet -- run up-for-rnv-color-palette-manager-status-family.py first. This script only moves "
...
EDITS = [
    ...
    ('tests/test_error_red.py',
     ...
     '        #b84e58   #f5f5f5 4.5123   #eeeeee 4.2401   #e8e8e8 4.0150   (rev 30)\n        #ae4650   #f5f5f5 5.0800   #eeeeee 4.7700   #e8e8e8 4.5200   (rev 31)\n', 1),
]

QUOTE = '"'
NAMES = ['STATUS_ERROR_TEXT_LIGHT']
BEFORE = {'STATUS_ERROR_TEXT_LIGHT': '#b84e58'}
VALUE_FILES = ['ui/colors.py', 'tests/test_error_red.py']
...
REWALKED = {'STATUS_ERROR_TEXT_LIGHT': '#ae4650'}
