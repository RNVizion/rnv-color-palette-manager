...
rnv-color-palette-manager: stop calling Image.getdata(), which Pillow removes on 2027-10-15.
...
SENTINEL_FILE = "core/color_extractor.py"
...
EDITS = [('core/color_extractor.py', 'from utils.logger import Logger, get_logger_instance\n', 'from utils.logger import Logger, get_logger_instance\nfrom utils.pil_compat import flat_pixels\n', 1), ('core/color_extractor.py', '        raw_pixels = list(img.getdata())\n', '        raw_pixels = flat_pixels(img)\n', 1), ('core/color_slot.py', 'from utils.dialog_helper import DialogHelper\n', 'from utils.dialog_helper import DialogHelper\nfrom utils.pil_compat import flat_pixels\n', 1), ('core/color_slot.py', '        pixels = list(calc_image.getdata())\n', '        pixels = flat_pixels(calc_image)\n', 1)]
